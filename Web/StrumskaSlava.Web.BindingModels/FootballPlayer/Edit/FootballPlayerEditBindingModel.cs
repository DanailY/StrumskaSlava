...
namespace StrumskaSlava.Web.BindingModels.FootballPlayer.Edit
{
    public class FootballPlayerEditBindingModel : IMapTo<FootballPlayerServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
                .CreateMap<FootballPlayerEditBindingModel, FootballPlayerServiceModel>()
            ...
            configuration
                .CreateMap<FootballPlayerServiceModel, FootballPlayerEditBindingModel>()
                .ForMember(destination => destination.Picture,
                            opts => opts.Ignore())
                .ForMember(destination => destination.PlayerPosition,
                            opts => opts.MapFrom(origin => origin.PlayerPosition.Name));
        }
    }
}
